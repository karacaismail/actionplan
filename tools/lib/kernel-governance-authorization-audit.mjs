...
const PARENT_GATE = "node tools/agents/check-kernel-governance.mjs && vitest run tests/kernelGapInventory.test.ts tests/kernelCodeBearingDescendantHandoff.test.ts tests/kernelDbSubstrateQueueHandoff.test.ts tests/kernelGovernanceGapAddendum.test.ts tests/kernelGovernanceDecisionRegistry.test.ts tests/kernelGovernanceDecisionPack.test.ts tests/kernelAdrCollisionSourceBindings.test.ts tests/kernelGhostWbsDirectiveBindings.test.ts tests/kernelTenancyAuthorityInventory.test.ts tests/kernelCrosscutHandoff.test.ts tests/kernelMissingDocRefPlacement.test.ts tests/kernelSurfaceDependencyOrderHandoff.test.ts && npm run qa:kernel-governance-authority";
