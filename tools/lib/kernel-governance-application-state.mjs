...
const HEAD_EPOCH_ID = "AUTHORITY-SUPERSESSION-04";
...
export function validateKernelGovernanceApplicationState({ state, closure, chain, registry, scripts, evidence } = {}) {
  ...
  // The GATE-01 intake is immutable historical evidence: it stays all-false whatever the live head
  // now allows. Only the ledger gate moved with EPOCH-04.
  ...
  // biome-ignore format: the live EPOCH-04 head stamp contract stays compact
