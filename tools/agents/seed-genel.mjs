...
const CONTENT = {
  "app-genel": D(
    "Genel",
    "Genel — kümeye girmeyen yatay/denetim sayfalarının toplandığı genel başlık",
    {
  ...
  "app-modul-matrisi": D(
    "App-Modül Matrisi",
    "App → Modül Matrisi — hangi app hangi modülü/ArcheType'ı Core veya Opsiyonel kullanır (tek denetlenebilir yüzey)",
    {
