...
const CONTENT = {
  ...
  "app-data-intelligence-x-stone": {
    ...
    moduleUsage: [
      "AI taşı bir alt-yetenektir; bağımsız sunulmaz, üst ArcheType içinde kullanılır",
    ],
  },
  ...
  "app-data-intelligence-x-molecule": {
    ...
    moduleUsage: [
      "AI molekülü bir bileşendir; bağımsız sunulmaz, üst yetenek içinde kullanılır",
    ],
  },
