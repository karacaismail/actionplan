...
const CONTENT = {
  "app-meta": D("Meta", "Meta & Genel Bakış — projenin üst seviye haritası, felsefesi ve yönetici özetini toplayan başlık", {
  ...
  "overview": D("Yönetici Özeti", "Yönetici özeti — 70+ ürünlük, 9 kategorili Super-ERP / AI-first SaaS framework'ünün master haritası", {
  ...
  "philosophy": D("Felsefe", "Felsefe ve ana prensipler — projenin uyduğu temel kurallar ve bu kararların gerekçesi", {
  ...
  "board": D("Tahta", "Tahta — yeniden yapılandırılmış 5 küme iskeletinin tam doldurulması; her küme ve neyin neden eklendiği", {
