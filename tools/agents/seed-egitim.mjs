...
const CONTENT = {
  "app-egitim": D(
    "Eğitim Rehberi",
    "Egitim — üç kişilik 60+ ekibin vibecoding ile üretime geçişini anlatan rehber kümesi",
    {
  ...
  "edu-baslangic-rotasi": D(
    "Başlangıç Rotası",
    "Buradan Başla — Gün 1 İlk Çalışan Kanıt: ilk 90 dakikada doğru repo, tek küçük hedef, çalışan test, yerel ayağa kaldırma",
    {
  ...
  "edu-faz-haritasi": D(
    "Faz Haritası",
    "Vibecoding × İnşa Sırası — Faz Haritası: hangi üniteyi bitirince hangi inşa fazında AI ile güvenle üretilebilir (u01–u25 ↔ Faz 0-7)",
    {
  ...
  "edu-prompt-kutuphanesi": D(
    "Prompt Kütüphanesi",
    "Kopyala–Çalıştır Prompt Kütüphanesi: Claude/Cursor/Antigravity için başlangıç, test-önce üretim, bağımsız review ve CI düzeltme prompt'ları",
    {
  ...
  "edu-waterfall-yol-haritasi": D(
    "Waterfall Yol Haritası",
    "Waterfall ile Enterprise-Ready Yol Haritası: başla → ilerle → şelale fazlarıyla geliştir → her fazın bitiş kapısı",
    {
  ...
  "edu-yetkinlik-modeli": D(
    "Yetkinlik Modeli",
    "Vibecoding Yetkinlik Modeli — Okumadan Üretim İşletimine: dört kanıt seviyesi, uygulamalı sınavlar, görev rotasyonu",
    {
