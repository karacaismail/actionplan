...
## Girdiler
Persona/iş hedefi, sayfa akışı, içerik envanteri, UI durumları ve kullanıcı geri bildirimi.
## Çıktılar
Bilgi mimarisi, önceliklendirilmiş içerik yerleşimi, microcopy ve ölçülebilir UX kabul ölçütleri.
## Yetkinlikler ve kapılar
Görev tamamlama akışı, bilişsel yük, progressive disclosure ve hata/boş durum denetimi.
## Sınırlar
