...
## Girdiler
Ürün hedefi, kullanıcı sonucu, kanonik WBS/JSON, bağımlılıklar ve kabul ölçütleri.
## Çıktılar
Kapsam içi/dışı tanımı, iş değeri, task kırılımı, bağımlılık ve kabul ölçütü önerileri.
## Yetkinlikler ve kapılar
Ürün kapsamı, değer/risk sıralaması, dikey dilimleme ve içeriği doğru task'a yerleştirme.
## Sınırlar
