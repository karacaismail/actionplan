...
## Girdiler
Kanonik kernel sözleşmeleri, WBS/DAG, generated nodes, docs ve implementation evidence.
## Çıktılar
İçerik-yüzey matrisi, dependency/gap listesi, sıra önerisi ve kernel entegrasyon handoff'u.
## Yetkinlikler ve kapılar
Kernel-SDK-app delivery sequence, izlenebilirlik, contract boundary ve sızma kontrolü.
## Sınırlar
