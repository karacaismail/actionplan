...
## Girdiler
Kabul ölçütleri, risk haritası, sözleşmeler, önceki hata kayıtları ve değişiklik diff'i.
## Çıktılar
Test matrisi, fixture/assertion tasarımı, red-green kanıtı ve kalan kapsama boşlukları.
## Yetkinlikler ve kapılar
Deterministik test, negatif/edge case, tenant izolasyonu ve doğru katmanda assertion seçimi.
## Sınırlar
