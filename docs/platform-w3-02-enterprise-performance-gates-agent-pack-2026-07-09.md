...
Bu belge product code üretmez. Amaç, W3-01 Enterprise Security Gates kanıtı kapandıktan sonra açılacak W3-02 işini yalnız insan geliştiriciye verilecek sıkı prompt ve evidence sözleşmesine dönüştürmektir.
...
İnsan geliştirici aşağıdaki execution paketini `/Users/karaca/DEV/mimari/platform` içinde, yalnız W3-01 evidence kapandıktan sonra kullanır:
