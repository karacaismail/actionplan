...
Bu belge product code üretmez. Amaç, W4-03 Module Marketplace Guardrails kanıtı kapandıktan sonra açılacak W4-04 işini implementation operatörünün Claude Code/Cursor/Aider gibi bir kod ajanına verebileceği sıkı prompt ve evidence sözleşmesine dönüştürmektir.
...
Bu kanıtlar yoksa W4-04 prompt'u kod ajanına verilmez; yalnız hazırlık/handoff dokümanı olarak kalır.
...
Implementation operatörü aşağıdaki prompt'u `/Users/karaca/DEV/mimari/platform` içinde, yalnız W4-03 evidence kapandıktan sonra kullanır:
