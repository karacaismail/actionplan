...
| İnsan platform geliştiricisi | Handoff'u `platform` branch'inde uygular, testleri koşturur, PR üretir ve gerçek kanıtı sağlar | AI çıktısını körlemesine merge etmez; actionplan verisini kanıtsız done yapmaz |
| Codex / PM / uzman ajanlar | Salt-okunur audit, kapsam, koordinasyon ve handoff önerisi üretir | Platform branch'i, ürün kodu, test, commit veya PR yazmaz |
...
Bu döngü her task için tekrarlanır. İnsan "devam et" dediğinde actionplan tarafındaki
doc-maintainer plan/handoff kısmını kapatır; yalnız insan platform geliştiricisi ayrı
repo/branch'te ürün kodu üretir.
