...
Bu belge product code üretmez. Amaç, W4-05 Evidence Dashboard Blockers kanıtı kapandıktan sonra açılacak W4-06 işini implementation operatörünün Claude Code/Cursor/Aider gibi bir kod ajanına verebileceği sıkı prompt ve evidence sözleşmesine dönüştürmektir.
...
Bu kanıtlar yoksa W4-06 prompt'u kod ajanına verilmez; yalnız hazırlık/handoff dokümanı olarak kalır.
...
Implementation operatörü aşağıdaki prompt'u `/Users/karaca/DEV/mimari/platform` içinde, yalnız W4-05 evidence kapandıktan sonra kullanır:
