...
Bu belge product code üretmez. Amaç, W4-01 Ready-To-Code Queue Export kanıtı kapandıktan sonra açılacak W4-02 işini implementation operatörünün Claude Code/Cursor/Aider gibi bir kod ajanına verebileceği sıkı prompt ve evidence sözleşmesine dönüştürmektir.
...
Bu kanıtlar yoksa W4-02 prompt'u kod ajanına verilmez; yalnız hazırlık/handoff dokümanı olarak kalır.
...
Implementation operatörü aşağıdaki prompt'u `/Users/karaca/DEV/mimari/platform` içinde, yalnız W4-01 evidence kapandıktan sonra kullanır:
