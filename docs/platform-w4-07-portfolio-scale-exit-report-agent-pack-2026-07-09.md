...
Bu belge product code üretmez. Amaç, W4-06 Operations Runbook Drills kanıtı kapandıktan sonra açılacak W4-07 işini implementation operatörünün Claude Code/Cursor/Aider gibi bir kod ajanına verebileceği sıkı prompt ve evidence sözleşmesine dönüştürmektir.
...
Bu kanıtlar yoksa W4-07 prompt'u kod ajanına verilmez; yalnız hazırlık/handoff dokümanı olarak kalır.
...
Implementation operatörü aşağıdaki prompt'u `/Users/karaca/DEV/mimari/platform` içinde, yalnız W4-06 evidence kapandıktan sonra kullanır:
